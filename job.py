...
class Job:
    ...
    @property
    def getInstance(self, jobName):
        if jobName == "Integratto ERP Avulsos":
            job: JobAvulsos = JobAvulsos()
            job.jobName = AVULSOS
            job.categories = 3
        
        elif jobName == "ERP - Banco":
            job: JobBanco = JobBanco()
            job.categories = 5
            ...
            job: JobsInstaladorJenkinsV2 = JobsInstaladorJenkinsV2()
            job.categories = 6
        
        elif jobName == "MonitorMultinotas":
            job: JobInstaladorMultinotas = JobInstaladorMultinotas()
            job.categories = 6

        elif jobName == "InstaladorMDFE":
            job: JobInstaladorMDFE = JobInstaladorMDFE()
            job.categories = 6
